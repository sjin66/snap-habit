export default {
  ...
  quotes: [
    ...
    '"Progress is built in the moments you choose to show up."',
    '"You don\'t need a perfect day, just a better one."',
    '"Tiny actions today become big changes tomorrow."',
    '"Your future self will thank you for this check-in."',
    '"Discipline is choosing what matters most right now."',
    '"Momentum starts with one completed habit."',
    '"Stay patient—lasting change is quietly happening."',
    '"You\'re not starting over, you\'re strengthening your system."',
    '"The goal is not intensity, it\'s repeatability."',
    '"A streak begins again with this one action."',
    '"Done is powerful. Keep going."',
    '"Your identity follows your repeated actions."',
    '"Trust the process, especially on ordinary days."',
    '"Small promises kept build deep confidence."',
    '"Focus on today. That\'s where growth lives."',
    '"You\'re closer than you think—keep the chain alive."',
